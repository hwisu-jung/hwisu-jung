...
온디바이스 AI 지망 | 안드로이드 앱 개발 · LLM 경량화 · 모바일 추론

- 한국컴퓨터정보학회 하계학술대회 **우수논문상** 수상 (2026)
- 헬스케어 안드로이드 앱 `당연` 개발 (Kotlin, Jetpack Compose, MVVM)
- 다중 에이전트 LLM 리포트 파이프라인 설계·구현
- 온디바이스 Gemma 3 추론 전환 (270M IT 모델 경량화)
- 정보처리기사 · SQLD 취득
...
> 복약·혈당·생활습관 기록을 단일 루틴으로 통합한 네이티브 안드로이드 앱
>
...
> 온디바이스 추론용 Gemma 3 270M IT 모델 웨이트 호스팅
>
> 모바일 환경 배포를 위한 경량화 및 배포 파이프라인 구성
>
> **[GitHub](https://github.com/hwisu-jung/gemma3-270m-it-weights)**

## 🏆 Awards & Publications

### 우수논문상 — 한국컴퓨터정보학회 2026 하계학술대회

> 제2형 당뇨병 진단 초기 성인의 통합 자기관리를 위한 모바일 애플리케이션 '당연' 개발:
> 건강기록 기반 다중 에이전트 AI 리포트를 중심으로
>
> 제74차 한국컴퓨터정보학회 하계학술대회 (2026.07) · 공동저자
>
